let questions = [
  ...
  window.onload = displayMessage;
      ...
      function updateProgressBar() {
          ...
          const currentProgress = ((currentQuestion) / totalQuestions) * 105;
          console.log("bar")
      ...
      setTimeout(() => {
          displayResults({
            ...
            guidelines: ["Take deep breaths", "Ensure adequate sleep", "Exercise regularly"]
          });
        }, 1000);
  ...
  function displayResults(data) {
    ...
    switch (data.stress_level) {
        case 'Minimal':
        stressMessage.style.color = "#28a745"; 
        borderColor = "#28a745"; 
        break;
        case 'Moderate':
        stressMessage.style.color = "#ff9800"; 
        borderColor = "#ff9800"; 
        break;
        case 'High':
        stressMessage.style.color = "#dc3545";
        borderColor = "#dc3545"; 
        break;
        default:
        stressMessage.style.color = "#28a745";
    ...
    finalResultContainer.style.border = "2px solid #724ae8";
